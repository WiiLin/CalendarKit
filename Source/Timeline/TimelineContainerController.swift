...
public final class TimelineContainerController: UIViewController {
    ...
    lazy var fakeLeftTimelineView: LockTimelineView = LockTimelineView(timelineView: timeline)
    lazy var lockContainer: UIScrollView = UIScrollView(frame: view.bounds)
